...
node_modules/.bin/c-preprocessor --config pre-firstpass-config.json template/MainToken.sol build/template/MainToken.sol
echo "second pass"
...
node_modules/.bin/c-preprocessor --config $1 build/template/MainToken.sol contracts/MainToken.sol